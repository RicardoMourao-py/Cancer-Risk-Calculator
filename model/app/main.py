...
class ModelTrainer:
    ...
    def train_and_save_model(self):
        ...
        # Salvando o modelo
        parent_directory = Path(os.getcwd()) / 'models'  # Diretório onde o modelo será salvo
        filename = parent_directory / "classifier.pkl"
        model.save(filename)
if __name__ == "__main__":
    data_file_path = Path.cwd().parent / 'app' / 'data' / 'dados_simulados.csv'
